...
CREATE TABLE IF NOT EXISTS stock_info (
  ...
  stock_type VARCHAR(10) NOT NULL DEFAULT 'NORMAL',
  previous_close DECIMAL(18,2) NOT NULL DEFAULT 0.00,
  latest_price DECIMAL(18,2) NOT NULL DEFAULT 0.00,
  open_price DECIMAL(18,2) NOT NULL DEFAULT 0.00,
  trade_status VARCHAR(20) NOT NULL DEFAULT 'TRADING',
...
CREATE TABLE IF NOT EXISTS price_limit_config (
  stock_type VARCHAR(10) PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS order_book (
  ...
  INDEX idx_order_security_account (security_account_no),
